...
custom.config$random_state = 554# 923 554 
...
umap_p = umap_p + stat_ellipse( linetype = 1, aes( color = meta_data$Grading), level=.33, type ="t", size=1.5)
...
#svg("~/Downloads/Figure_2_C_Grading_validation.svg", width = 10, height = 10)
umap_p
dev.off()

# plot 4 net nec pca

nec_net_col_vec = meta_data$NET_NEC_PCA;
...
#svg("~/Downloads/Figure_2_D_valudation.svg", width = 10, height = 10)
umap_p
dev.off()
